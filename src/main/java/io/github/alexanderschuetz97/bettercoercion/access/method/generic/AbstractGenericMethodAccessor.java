...
public abstract class AbstractGenericMethodAccessor<X, T> implements MethodAccessor<X> {
    ...
    public Varargs invoke(Varargs args) {
        ...
        if (isVarArgs()) {
            ...
            return coerceResult(callV(instance, jargs));
        }
    ...
    public Varargs invoke() {
        return coerceResult(call0(coerceInstance(LuaValue.NONE)));
    }

    public Varargs invoke(LuaValue param1) {
        return coerceResult(call0(coerceInstance(param1)));
    }
    ...
    public Varargs invoke(LuaValue param1, LuaValue param2) {
        ...
        if (getArgCount() > 0) {
            return coerceResult(call1(instance, paramCoercion[0].coerce2J(param2, generics[0])));
        }

        return coerceResult(call0(instance));
    }
    ...
    public Varargs invoke(LuaValue param1, LuaValue param2, LuaValue param3) {
        ...
        switch (getArgCount()) {
            ...
            case(1):
                return coerceResult(call1(instance, paramCoercion[0].coerce2J(param2, generics[0])));
            default:
                return coerceResult(call2(instance, paramCoercion[0].coerce2J(param2, generics[0]), paramCoercion[1].coerce2J(param3, generics[1])));
        }
    }
