...
public class LuaValue_LuaValue_MethodAccessor extends AbstractSpecificMethodAccessor {
    ...
    public Varargs invoke(Varargs args) {
        ...
        try {
            return coerceResult(args.arg1(), inst, method.invoke(inst, args.arg(2), args.arg(3)));
        } catch (Throwable exc) {
    ...
    public Varargs invoke() {
        ...
        try {
            return coerceResult(LuaValue.NIL, null, method.invoke(inst, LuaValue.NIL, LuaValue.NIL));
        } catch (Throwable exc) {
            throw Util.wrapException(exc);
        }
    }
    ...
    public Varargs invoke(LuaValue param1) {
        ...
        try {
            return coerceResult(param1, inst, method.invoke(inst, LuaValue.NIL, LuaValue.NIL));
        } catch (Throwable exc) {
            throw Util.wrapException(exc);
        }
    }
    ...
    public Varargs invoke(LuaValue param1, LuaValue param2) {
        ...
        try {
            return coerceResult(param1, inst, method.invoke(inst, param2, LuaValue.NIL));
        } catch (Throwable exc) {
            throw Util.wrapException(exc);
        }
    }
    ...
    public Varargs invoke(LuaValue param1, LuaValue param2, LuaValue param3) {
        ...
        try {
            return coerceResult(param1, inst, method.invoke(inst, param2, param3));
        } catch (Throwable exc) {
            throw Util.wrapException(exc);
        }
    }
