...
import eu.aschuetz.bettercoercion.access.method.specific.*;
import eu.aschuetz.bettercoercion.coercion.*;
import eu.aschuetz.bettercoercion.coercion.array.*;
import eu.aschuetz.bettercoercion.coercion.collection.CollectionBiCoercion;
import eu.aschuetz.bettercoercion.coercion.collection.IterableBiCoercion;
import eu.aschuetz.bettercoercion.coercion.collection.ListBiCoercion;
import eu.aschuetz.bettercoercion.coercion.collection.MapBiCoercion;
import eu.aschuetz.bettercoercion.coercion.luavalues.*;
import eu.aschuetz.bettercoercion.coercion.primitives.*;
import eu.aschuetz.bettercoercion.math.LuaMathHelper;
import eu.aschuetz.bettercoercion.userdata.array.LuaByteArray;
import eu.aschuetz.bettercoercion.userdata.array.LuaCharArray;
import eu.aschuetz.bettercoercion.util.DummyUserdataFactory;
import eu.aschuetz.bettercoercion.util.FilteredUserdataFactory;
...
public class LuaCoercion {
    ...
    protected void addDefaultMethodAccessorFactories() {
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(String.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        });

        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(Long.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(Double.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(Float.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(Short.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(Character.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(Byte.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(Boolean.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(Integer.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(char.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.InstanceMethodAccessorFactory(int.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(String.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(Long.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(Double.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(Float.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(Short.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(Character.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(Byte.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(Boolean.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(Integer.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(char.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
        ...
        addMethodAccessorFactory(new MethodAccessorFactory.StaticMethodAccessorFactory(int.class) {
            @Override
            public MethodAccessor create(Method method) {
                return new Object_MethodAccessor(method);
            }
